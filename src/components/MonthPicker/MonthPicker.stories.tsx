      ...
      return (
        <VStack spacing={4} align="start" width="400px">
          ...
          {selectedRange && (
            ...
            >
              <Text fontSize="subtext" fontWeight="semibold" color="green.700">
                ✓ Range Selected:
              </Text>
              <Text fontSize="subtext" color="green.600">
...
export const WithConstraints: Story = {
  ...
  parameters: {
    additionalContent: (
      <Box>
        <Text fontSize="p" fontWeight="semibold" mb={2}>
  ...
  parameters: {
    additionalContent: (
      <Box>
        ...
        <Box fontSize="subtext" color="gray.700">
          <Text>
