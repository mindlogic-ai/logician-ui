...
// IconMap에서 모든 React Icons import
import {
...
// React Icons - 모든 IconMap의 React Icons
// BI Icons
...
export const IconTypes = {
  ...
  Language: 'Language',
  Layout: 'Layout',
  // Note: OneOnOne, Comment, Moment, Schedule, BasicData, Profile, Greeting, PersonaParameters
  // are custom icons that should be created in the consuming project using createIcon()
