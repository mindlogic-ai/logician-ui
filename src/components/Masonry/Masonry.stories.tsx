      ...
      <Masonry {...args}>
        {items.map((item) => (
          ...
          >
            ...
            <Text fontSize="subtext">Height: {item.height}px</Text>
          </Box>
        ))}
      </Masonry>
    );
      ...
      <Masonry {...args}>
        {categories.map((category) => (
          <Box
            ...
            mb={4}
          >
            <Text fontWeight="bold" fontSize="h5" mb={2} color="blue.500">
              {category.name}
            </Text>
...
export const CustomizableColumns: Story = {
  args: {
...
export const HorizontalArrangement: Story = {
  render: (args) => {
    const items = generateItems(12);

    return (
      <Box>
        <Text fontSize="h4" fontWeight="bold" mb={4}>
...
export const ComparisonWithGrid: Story = {
  render: (args) => {
    const items = generateItems(12);
